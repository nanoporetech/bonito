...
def thread_map(func, iterator, n_thread=4, maxsize=0):
    """
    ...
    return iter(ThreadMap(partial(MapWorkerThread, func), iterator, n_thread, output_queue=queue.Queue(maxsize)))
